...
Then, we used `Minimap2 (v.2.24)` (Li, 2018, <https://doi.org/10.1093/bioinformatics/bty191>, <https://github.com/lh3/minimap2>) and samtools (v.XXX) (<https://github.com/samtools/samtools>) to map the raw sequencing reads onto `culpip_masked.fa` and remove the mapped reads for downstream analyses:
